...
function Cover() {
  ...
  return (
    <section className="relative w-full min-h-screen">
      ...
      >
        <div className="text-sm sm:text-lg md:text-xl text-light-dark font-medium transition-all text-gradient-light">
          HEY! I&apos;M
        </div>
        <div className="text-4xl sm:text-5xl md:text-6xl text-brand font-bold tracking-widest">
          SHINJITH P R
        </div>
        <div>
          <div
