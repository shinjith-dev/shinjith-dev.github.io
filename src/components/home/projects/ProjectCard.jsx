...
function ProjectCard({ project }) {
  return (
    <div className="group transition-all duration-300">
      <div className="overflow-hidden rounded-3xl group-hover:shadow-spread-sm transition-all">
        ...
        <div className="px-4 py-3 bg-light dark:bg-dark-900 rounded-3xl z-10 relative -mt-8">
  ...
  //       <div className="bg-light dark:bg-dark-800 px-5 py-4 shadow-spread-xs -mt-6 transition-all duration-300 z-10 relative rounded-xl">
